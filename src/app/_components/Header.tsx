...
export const Header = () => {
  return (
    <div className="flex justify-around bg-white h-auto  py-5 px-3">
      <div>
      ...
      <div className="flex gap-3 ">
        <div className="rounded-full size-10 bg-blue-500 ">
          <img src="/cat.jpeg" alt="" className="rounded-full size-10" />
        </div>
